...
export default function Products() {
  ...
  const handleDelete = (id: string) => {
    ...
    if (productToDelete) {
      addLog({ user: 'Current User', action: 'DELETE', entity: 'Product', details: `Deleted product ${productToDelete.name}` });
    }
  };
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="edit-reorder" name="reorder" type="number" min="0" defaultValue={editingProduct.reorder} required />
                  </div>
                </div>
              </div>
              <DialogFooter>
